...
`], ...formatTraceEntry(entry));
  ...
  function flushJobs(seen2) {
    ...
    const check = false ? (job) => checkRecursiveUpdates(seen2, job) : NOOP2;
    try {
  ...
  function applyOptions(instance) {
    ...
    if (computedOptions) {
      for (const key in computedOptions) {
        ...
        const set2 = !isFunction2(opt) && isFunction2(opt.set) ? opt.set.bind(publicThis) : false ? () => {
          warn$1(
...
For more details, see https://link.vuejs.org/feature-flags.`
  ...
  function watchPostEffect(effect2, options) {
    return doWatch(
      effect2,
      null,
      false ? extend2({}, options, { flush: "post" }) : { flush: "post" }
    );
  }
  function watchSyncEffect(effect2, options) {
    return doWatch(
      effect2,
      null,
      false ? extend2({}, options, { flush: "sync" }) : { flush: "sync" }
    );
  }
...
Component that was made reactive: `,
  ...
  var EMPTY_OBJ3 = false ? Object.freeze({}) : {};
  var EMPTY_ARR3 = false ? Object.freeze([]) : [];
  ...
  var EMPTY_OBJ4 = false ? Object.freeze({}) : {};
  var EMPTY_ARR4 = false ? Object.freeze([]) : [];
  var NOOP4 = () => {
  };
  var NO2 = () => false;
  ...
  var isHTMLTag2 = /* @__PURE__ */ makeMap4(HTML_TAGS);
  var isSVGTag2 = /* @__PURE__ */ makeMap4(SVG_TAGS);
  var isMathMLTag2 = /* @__PURE__ */ makeMap4(MATH_TAGS);
    ...
    const opts = extend4(
      {
        ...
        onWarn: false ? (e) => onError(e, true) : NOOP4
      },
      options
    );
