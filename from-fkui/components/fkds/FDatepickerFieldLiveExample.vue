...
<template>
    <live-example :components="components" :template="template" :livedata="livedata">
        ...
        <f-checkbox-field v-model="alwaysInlineEnabled" :value="true"> Kalendern visas alltid inline </f-checkbox-field>
        <f-fieldset name="etikett">
            ...
            <f-checkbox-field v-model="descriptionVisible" :value="true"> Hjälptext </f-checkbox-field>
        </f-fieldset>
    </live-example>
</template>
